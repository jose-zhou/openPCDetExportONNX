...
onnx_path = os.path.join(abPath, 'tempTest/outPutONNX/3DDetectionModelyoloDown4.onnx')
...
def main():
    ...
    with torch.no_grad():
        ...
        for idx, data_dict in enumerate(demo_dataset):
            ...
            outputNames =['hm', 'center', 'center_z', 'dim', 'rot_cos', 'rot_sin']
            # onnx 导出

...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/kitti_models/my_centerpoint_yolo_down4.yaml', help='specify the config for training')
    ...
    parser.add_argument('--train_and_val', default=False, help='if it is true means train and val, if it is true means only  val')

...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        # print('sdsdxxx', dataset.class_names)
    ...
    def build_networks(self):
        model_info_dict = {
            ...
            # J 新增
            'num_bev_features': int((self.dataset.point_cloud_range[5] - self.dataset.point_cloud_range[2])/ self.dataset.voxel_size[2])
        }
    ...
    def post_processing(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            # 取出  一个batch中的预测数据  batch_box_preds
            box_preds = batch_dict['batch_box_preds'][batch_mask]
            src_box_preds = box_preds

            # 取出  一个batch中的预测数据  batch_cls_preds   必要的话进行一个normalize
